            ...
            <div class="container padding-bottom-3x mb-2 mt-5">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        ...
                        <form class="card mt-4" id="resetPassForm" action="forgotPasswordServlet" method="POST">
                            <div class="card-body">
                        ...
                        <div class="card-footer">
                            <button class="btn btn-success" type="submit" onclick="CheckOtp();">Get New
                                Password</button>
                            <script>
                                function CheckOtp() {
                                    let emailInput = document.getElementById("email-for-pass").value; // Get the email input value
